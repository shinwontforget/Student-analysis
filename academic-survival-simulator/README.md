...
Open your [Supabase SQL Editor](https://supabase.com/dashboard) and run the setup script found at [`frontend/supabase/schema.sql`](frontend/supabase/schema.sql):
